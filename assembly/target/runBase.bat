...
if exist thirdparty\jdk1.6.0_25\bin\java.exe set _JAVACMD=thirdparty\jdk1.6.0_25\bin\java.exe
...
"%_JAVACMD%" %DEBUG% -Xms512M -Xmx1024M %JMX% -Djsystem.main=%JSYSTEM_MAIN% -DentityExpansionLimit=1280000 -classpath "%JSYSTEM_USED_CLASSPATH%" %SPLASH% jsystem.framework.launcher.Launcher2 %1 %2 %3 %4 %5 %6 %7
