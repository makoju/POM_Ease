...
public class CustomSchedulePage extends AbstractPageObject {
	...
	public boolean insertRecordintoJobSchedule(String agencyName, String jobtype, String jobid, String customerid){
		...
		String query1 =  "DELETE From ddez.jobschedule where jobtype="+jobtype;  //providerid in (select p.id from ddez.provider p where p.DisplayName='"+agencyName+"'  and p.customerid="+customerid+")
